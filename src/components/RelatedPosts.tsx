            ...
            <div className="not-prose text-balance">
                ...
                >
                    {posts.map((post) => (
                        <li
                            key={post._key}
                            className="p-4 bg-base-content text-accent-content sm:w-1/3 flex-shrink-0 transform hover:scale-105 transition-all duration-300 ease-in-out hover:rounded-md hover:shadow-md hover:shadow-accent/80"
                            data-sanity={createDataAttribute({
                                ...createDataAttributeConfig,
                                id: documentId,
                                type: documentType,
