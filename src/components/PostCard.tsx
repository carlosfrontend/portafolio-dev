...
export function PostCard(props: POSTS_QUERYResult[0]) {
    ...
    return (
        <Link className="card drop-shadow-xs drop-shadow-base-content transform bg-base-200 hover:scale-105 transition-all duration-300 ease-in-out group " href={`/blog/${props.slug!.current}`}>
