...
export function ProjectCard(props: PROJECTS_QUERYResult[0]) {
  ...
  return (
    <div className="card hover:border hover:border-base-content transform bg-base-200 hover:scale-105 transition-all duration-300 ease-in-out group max-w-[450px]">
