...
export default function Stats({ blogCount, projectCount }: { blogCount: number, projectCount: number }) {
    ...
    return (
        <div className=' py-10 flex justify-start gap-4  items-stretch flex-wrap w-full  md:justify-center '>
            <Link href="/projects" className='hover:scale-105 border-1 transition-all duration-300 ease-in-out hover:shadow-lg group w-full md:w-[210px]'>
            ...
            <Link href="/blog" className='hover:scale-105 transition-all border-1 ease-in-out duration-300 hover:shadow-lg group w-full md:w-[210px]'>
                <div className="shadow">
                    <div className="stat w-full gap-2  border-none bg-base-100">
